...
public class KeypadAsterik extends Dialog  
{
	protected static final String TAG = "Sudoku";
	private final View keys[] = new View[9];
	private View keypad;
	private final int useds[];
	private final PuzzleViewAsterik puzzleView;
	
	public KeypadAsterik(Context context, int useds[], PuzzleViewAsterik puzzleView) 
	{
	super(context);
	this.useds = useds;
