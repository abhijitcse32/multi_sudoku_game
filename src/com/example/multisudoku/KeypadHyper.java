...
public class KeypadHyper extends Dialog  
{
	protected static final String TAG = "Sudoku";
	private final View keys[] = new View[9];
	private View keypad;
	private final int useds[];
	private final PuzzleViewHyper puzzleView;
	
	public KeypadHyper(Context context, int useds[], PuzzleViewHyper puzzleView) 
	{
	super(context);
	this.useds = useds;
