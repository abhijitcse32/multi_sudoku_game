...
public class KeypadCenterDot extends Dialog  
{
	protected static final String TAG = "Sudoku";
	private final View keys[] = new View[9];
	private View keypad;
	private final int useds[];
	private final PuzzleViewCenterDot puzzleView;
	
	public KeypadCenterDot(Context context, int useds[], PuzzleViewCenterDot puzzleView) 
	{
	super(context);
	this.useds = useds;
